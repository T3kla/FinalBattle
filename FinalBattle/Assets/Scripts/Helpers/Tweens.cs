...
public class Tweens
{
    ...
    public static async UniTask Scale(CanvasGroup group, float i, float f, float duration = 1.0f, CT ct = default)
    {
    ...
    public static async UniTask Fade(CanvasGroup group, float i, float f, float duration = 1.0f, CT ct = default)
    {
        if (duration <= 0.0f) goto end;
